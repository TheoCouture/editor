...
public class RectangleTest extends TestCase {
    ...
    public void testJson() throws Exception {
        ...
        assertEquals(JSON.GraphicToJSON(r), "{ type: rectangle, center: { type: point, x: 0.0, y: 0.0 }, height: 3.0, width: 7.0 }");
    }
    ...
    public void testCopy() throws Exception {
        ...
        assertEquals(JSON.GraphicToJSON(r),JSON.GraphicToJSON(r.copy()));
    }
